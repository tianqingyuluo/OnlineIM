...
# -*- coding: utf-8 -*-
"""
Inject change_logs specification into Codex sessions.
...
def main() -> None:
    if os.environ.get("TRELLIS_HOOKS") == "0" or os.environ.get("TRELLIS_DISABLE_HOOKS") == "1":
        sys.exit(0)
    if os.environ.get("CODEX_NON_INTERACTIVE") == "1":
        sys.exit(0)
    ...
    result = {
        "suppressOutput": True,
        "systemMessage": f"change_logs spec injected ({len(context_block)} chars)",
        "hookSpecificOutput": {
