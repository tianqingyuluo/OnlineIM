...
<template>
  <Sidebar
      ...
      collapsible="none"
      class="bg-white transition-all duration-300 w-full h-full border-r border-gray-200"
  >
    <SidebarGroupLabel
    ...
    <UserPart
        ...
        class="fixed z-50 w-[90%] max-w-md top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
    />
