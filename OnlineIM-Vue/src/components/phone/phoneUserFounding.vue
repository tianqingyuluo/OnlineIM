...
import usersSelectResult from '@/components/independent/founding/usersSelectResoult.vue'
import FriendRequestsList from "@/components/independent/founding/FriendRequestsList.vue";
import GroupSelectResult from '@/components/independent/founding/GroupSelectResult.vue';
// 拖动逻辑
...
<template>
  <div ref="modalRef" class="fixed z-50 top-[10%] left-[30%] w-[80%] max-w-2xl rounded-lg">
    <div class="bg-white shadow-lg w-full rounded-lg">
      ...
      <!-- 内容区域 -->
      <div class="p-6 bg-white  overflow-auto h-[400px] rounded-b-lg">
